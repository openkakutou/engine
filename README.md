...
That compiled module doesn't need to be built locally — every tagged release publishes a ready-to-use `engine.wasm` + `wasm_exec.js` pair as GitHub Release assets. See [docs/wasm.md](docs/wasm.md) for the full JS API contract, how to build the module locally, and the release pipeline that publishes it.
<!-- vibe:end:usage -->
